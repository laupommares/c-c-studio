...
export default function CheckoutPage() {
  ...
  const getStepContent = () => {
    ...
    if (isRenderStep) {
      return {
        title: "¿Necesitás renders 3D?",
        subtitle: "Imágenes fijas de alta calidad, perfectas para tus materiales de marketing.",
        options: [
          {
            id: "yes",
            title: "Si, agregar renders",
            emoji: "🖼️",
            action: () => {
