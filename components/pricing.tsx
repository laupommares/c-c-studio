      ...
      <div className="container mx-auto px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-neutral-400" itemProp="description">
            ¿Preferís algo único? Contactanos y lo preparamos a tu medida.
          </p>
          <div className="mt-6">
            <Button
              asChild
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <CardHeader className="space-y-3 pb-4">
              ...
              <div className="flex gap-2">
                ...
                >
                  <Link href="/checkout?plan=startup">Elegir</Link>
                </Button>
              </div>
            </CardHeader>
          ...
          >
            <CardHeader className="space-y-3 pb-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  style={{ backgroundColor: ACCENT }}
                >
                  <Link href="/checkout?plan=pro">Elegir</Link>
                </Button>
              </div>
            </CardHeader>
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "Logo profesional + manual básico de marca.",
                  "Diseño de tarjetas personales.",
                  "Feed inicial (12 posts + 4 historias).",
                  "Landing optimizada con captación de leads",
                ].map((f, i) => (
                  <FeatureItem key={i} text={f} />
                ))}
              </ul>
          ...
          >
            <CardHeader className="relative space-y-3 pb-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  style={{ backgroundColor: ACCENT }}
                >
                  <Link href="/checkout?plan=premium">Elegir</Link>
                </Button>
              </div>
            </CardHeader>
            ...
            <CardContent className="relative pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "Identidad completa (logo, colores, tipografía, tono de voz).",
                  "Estrategia visual para 3 meses de Instagram.",
                  "Web autoadministrable + blog.",
